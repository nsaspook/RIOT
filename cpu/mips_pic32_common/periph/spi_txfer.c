 ...
 * Processor:       PIC32MX
 *
 * Compiler:        MPLAB XC32 v1or higher
...
#if !defined(_DMAC) || !defined(_SPI_DEF_CHN_)
    #error "This example needs a PIC32MX processor with DMA controller and SPI present. Aborting build!"
#endif  // _DMAC
